...
func SecureJWTOK(t goatest.TInterface, ctx context.Context, service *goa.Service, ctrl app.JWTController) (http.ResponseWriter, *app.GoaJWTTestSuccess) {
	// Setup service
	var (
		logBuf bytes.Buffer
		resp   interface{}
	...
	var mt *app.GoaJWTTestSuccess
	if resp != nil {
		var _ok bool
		mt, _ok = resp.(*app.GoaJWTTestSuccess)
		if !_ok {
			t.Fatalf("invalid response media: got variable of type %T, value %+v, expected instance of app.GoaJWTTestSuccess", resp, resp)
		}
	}
